    ...
    <form @submit="submit" class="border border-gray-200 rounded-2xl py-6 bg-white" action="/viagens/rotas/create"
        ...
        <div class="flex px-6">
            ...
            <div class="flex flex-col justify-center">
                <h2 class="text-lg font-medium">Nova Rota de viagem</h2>
                <p class="text-sm font-normal text-slate-600 my-0">Preencha os detalhes da sua nova rota de viagem.</p>
            </div>
        </div>
            ...
            <div class="flex mt-3 flex-col gap-4">
                ...
                <div class="flex gap-10 w-full">
                    <div class="flex flex-col  gap-2">
                        ...
                        <label class="input rounded-2xl">
                            <input type="text" required placeholder="Ex: 3 horas" />
                    ...
                    <div class="flex flex-col  gap-2">
                        ...
                        <label class="input  rounded-2xl">
                            <input type="time" required v-model="form.horario_partida" placeholder="Ex: 08:00"
                ...
                <div class="flex gap-5  w-full mt-4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <label class="input rounded-2xl w-60">
                            <input type="number" required v-model="form.valor" placeholder="Ex: 50"
                                name="valor" />
                            <font-awesome-icon icon="users" class="text-gray-500" />
                        </label>
                    </div>
                ...
                <div class="flex flex-col gap-2 w-full mt-5 ">
                    ...
                    <textarea class="input rounded-2xl h-24 resize-none pt-2 w-full"
...
function submit(e) {
    e.preventDefault()
    form.post('/viagens/rotas/create', {
        onSuccess: () => {
            console.log('Rota criada com sucesso!')
        },
        onError: (errors) => {
            console.error('Erro ao criar rota:', errors)
        },
        forceFormData: true
    })
}
